...
class PascalVOC2coco(object):
    ...
    def getsegmentation(self):
        ...
        try:
            ...
            for i in range(mean_x, end):
                ...
                y_ = mean_y
                pixels = mask_1[y_, x_]
                if pixels != 0 and pixels != 220:  # 0 ��Ӧ���� 220��Ӧ�߽���
    ...
    def mask2polygons(self):
        contours = cv2.findContours(self.mask, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)  # �ҵ�������
        bbox=[]
    ...
    def mask2box(self, mask):
        ...
        return [left_top_c, left_top_r, right_bottom_c - left_top_c,
                right_bottom_r - left_top_r]  # [x1,y1,w,h] ��ӦCOCO��bbox��ʽ
...
xml_file = glob.glob('/data/wanglan/maskrcnn-heads/maskrcnn-benchmark/datasets/coco_4part/test_ano_new/*.xml')
# xml_file=['./Annotations/000032.xml']
#xml_file=['00000007_05499_d_0000037.xml']
PascalVOC2coco(xml_file, '/data/wanglan/maskrcnn-heads/maskrcnn-benchmark/datasets/coco_4part/test.json')